...
const guides = [
  [
    resolve(projectRoot, 'docs', 'public', 'OPERATIONS_AND_MIGRATION.md'),
    'operations-and-migration.md',
    'Operations & migration',
    'The public runbook for installing, operating, recovering, and migrating RWR 5.',
  ],
  [
    resolve(projectRoot, 'RELEASE_NOTES.md'),
    'release-notes.md',
    'Release notes',
    'New features, fixes, upgrade notes, and compatibility details for ResourceWorldResetter.',
  ],
];
...
for (const [sourcePath, targetName, title, description] of guides) {
