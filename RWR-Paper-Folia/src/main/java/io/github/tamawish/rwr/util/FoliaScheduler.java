...
/**
 * Folia / Paper compatible scheduler helpers for entity, region, and async work. Prefer
 * GlobalRegionScheduler for non-region work.
 */
public final class FoliaScheduler {
  ...
  /**
   * Starts repeating work on the global-region scheduler.
   *
   * @param task work to execute
   * @param delayTicks delay before the first execution
   * @param periodTicks delay between executions
  ...
  /**
   * Returns a future completed by the asynchronous scheduler after a delay.
   *
   * @param millis nonnegative delay in milliseconds
