...
public final class TeleportService {
  ...
  public TeleportService(
      Supplier<TeleportSettings> settings, WorldProvider gateway, ResetAccessPolicy resetAccess) {
    this(settings, gateway, resetAccess, name -> name);
  }

  /**
   * Creates a teleport service with provider-aware display names.
   *
  ...
  /**
   * Revalidates and synchronously teleports a player to a safe destination.
   *
   * @param player player requesting teleportation
   * @param requestedWorld provider-specific world name
   * @return teleport outcome
   */
